        ...
        <div className="page-wrapper">
            ...
            <div className="container">
              ...
              <div className="company__card">
                <div className="company__card__item">
                  ...
                  <p>
                    I'm a full stack developer currently working as CTO at
                    Wehance with a wide collection of skills, an extensive
                    knowledge base and more than 8 years of experience in the
                    tech business.
                  </p>
                </div>
                <div className="company__card__item">
          ...
          <section className="section chat">
            <div className="container">
              ...
              <p className="section__subtitle">
                I’m always happy to talk about working together, new
                opportunities or just catching up. If you’d like to get in
                touch, just shoot me an email with the link below.
              </p>
            ...
            <div className="footer__widget">
              ...
              <div className="footer__widget__right">
                <div className="widget-link-text">
                  ...
                  <Link to="">hello@kasunsuess.de</Link>
                </div>
